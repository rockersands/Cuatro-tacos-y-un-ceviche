	...
	public class ActionListAssetEditor : Editor
	{
		...
		public override void OnInspectorGUI ()
		{
			...
			else
			{
				...
				{
					EditorGUILayout.BeginHorizontal ();
					if (GUILayout.Button ("Edit Actions", EditorStyles.miniButtonLeft, GUILayout.Height (40f)))
					{
						ActionListEditorWindow.Init (_target);
					}
					if (GUILayout.Button ("Run now", EditorStyles.miniButtonRight, GUILayout.Height (40f)))
					{
						AdvGame.RunActionListAsset (_target);
					}
					EditorGUILayout.EndHorizontal ();
